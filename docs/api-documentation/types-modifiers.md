...
#### hexcolor
Validate string value against valid hex color. This also removes # at the
...
@jsonclass
class Theme:
    tint_color: str = types.str.hexcolor.required
```
...
#### fobj
Get the referenced object at field from a JSONClass object. If the object is
not attached yet, include it.
#### Usage
